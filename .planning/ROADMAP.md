...
Plans:
- [ ] 01-01-PLAN.md — Project scaffold: pyproject.toml, requirements/, Dockerfile, docker-compose.yml (4 services + health checks)
- [ ] 01-02-PLAN.md — App core structure: Settings config, FastAPI factory, DB base + async session, all 9 ORM models
- [ ] 01-03-PLAN.md — Alembic setup: async-compatible env.py, initial migration creating all 9 tables
